  ...
  return (
    <div>
      <div
        ...
        data-wow-delay="1s"
      >
        <div className="continer rounded p-2 bg-white col-md-12">
          <form>
            <ul className="pl-0 mb-0  form-row booking_ul">
               <ul className={`${styles.booking_ul} align-items-center pl-0 mb-0 form-row`}>
