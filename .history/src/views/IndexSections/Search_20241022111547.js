    ...
    <div class="col-md-12 form-group has-feedback"> <a href="#" class="booking_close_btn">X</a>
        <ul class="booking_ul">
            ...
            <li>
                ...
                <div class="form-group">
                    <input id="dp1" type="text" class="form-control clickable input-md" readonly="" placeholder="Arrival"></div>
            </li>
            <li>
                <label>Check Out</label>
                <div class="form-group">
                    <input id="dp2" type="text" class="form-control clickable input-md" readonly="" placeholder="Departure"></div>
            </li>
            <li>
                <label>Rooms</label>
